...
angular.module('gapi', [])
  ...
  .factory('GAPI', function ($q, $http, $log, GoogleApp) {
    ...
    function oauthHeader(options) {
      ...
      options.headers['Authorization'] = 'Bearer ya29.ElkGBBTgBkC4DMgBkju76jJ4AFR8hSIuprfrEApvmQ2xys3J__KRgqLE0PebrVQw2krejEXfIzK-H3If1FCP0Dv2WgWxORJltyk4MZjA_W-6xcRNfjbdSUZrrg';// + GAPI.app.oauthToken.access_token;
    }

    function oauthParams(options) {
      if (!options.params) { options.params = {}; }
      options.params.access_token = 'ya29.ElkGBBTgBkC4DMgBkju76jJ4AFR8hSIuprfrEApvmQ2xys3J__KRgqLE0PebrVQw2krejEXfIzK-H3If1FCP0Dv2WgWxORJltyk4MZjA_W-6xcRNfjbdSUZrrg'//GAPI.app.oauthToken.access_token;
    }
