...
(function (mod) {
    ...
    mod.controller('mainCtrl',['$scope', 'applicationService', 'builderService', '$location',function ($scope, applicationService, builderService, $location) {
...
//++++++++++++++++++++++++++++++++++++++  SYSTEM ADMIN  +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    mod.controller('sysAdminItemController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
        $scope.itemList = [];
        $scope.count = 0;
        var shopDetails = {};
        var itemPerPage = 8;
    ...
    mod.controller('sysAdminBranchesController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
        $scope.branchList = [];
        $scope.tmp = {};
        $scope.branch = {};
        $scope.branch.pos = [];
    ...
    mod.controller('sysAdminShopsController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
    ...
    mod.controller('sysAdminUsersController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
        $scope.userList = [];
        $scope.tmp = {};
        $scope.tmp.profilePic = [];
        $scope.tmp.entitlements = [];
    ...
    mod.controller('sysAdminPromotionsController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
        $scope.promotionList = [];
        $scope.promotion = {};
        $scope.tmp = {};
        $scope.tmp.promotionPic = [];
    ...
    mod.controller('sysAdminExtrasController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG','ADMIN_MOD_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG, ADMIN_MOD_CONFIG) {
    ...
    mod.controller('sysAdminExtraProfileController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
    ...
    mod.controller('sysAdminExtraMessageController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG','$mdDialog','$mdMedia', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG, $mdDialog, $mdMedia) {
        $scope.unreadCount = 0;
        $scope.draftCount = 0;
        $scope.shopDetails = {};
    ...
    mod.controller('sysAdminExtraTagsController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
    ...
    mod.controller('sysAdminExtraBlogController', ['$scope', '$rootScope','$state','adminDataService','Data.Toast','MESSAGE_CONFIG', function ($scope, $rootScope, $state, adminDataService, Data_Toast, MESSAGE_CONFIG) {
        $scope.blogImageSize = {value:500000, text:'500kB'};
        $scope.blogImageCount = 1;
        $scope.blogImage = [];
        $scope.blogData = {};
...
})(com.TRENDI.ADMIN.modules.adminModule);
